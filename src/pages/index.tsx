    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-300 flex items-center justify-center">
        <div className="bg-white p-4 rounded-md">
          ...
          <Botao className="w-60 text-white px-4 py-2 rounded-md" cor="purple" onClick={() => Router.push('/search')}>Entrar</Botao>
        </div>
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <Botao className="w-60 text-white px-4 py-2 rounded-md" cor="purple" onClick={() => Router.push('/login')}>Login</Botao>
        </div>
